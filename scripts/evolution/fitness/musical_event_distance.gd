...
# measures the distance between two musical elements
...
static func get_distance(anchor_a, anchor_b) -> float:
	...
	push_error("Cannot measure Pitch distance between different anchor types.")
	return INF

# for triangles: find best permutation of pitch-pairs and return distance / number of pitches
