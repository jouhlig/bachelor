...
# turns an L-system string into actions in the Tonnetz
...
func get_next_triangle_anchor(current_anchor: TonnetzTriangle):
...
func get_edge_between_triangles(from_triangle: TonnetzTriangle, target_triangle: TonnetzTriangle) -> int:
